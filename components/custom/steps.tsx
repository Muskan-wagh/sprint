...
const steps = [
  {
    ...
    description:
      "Integrate your existing workflow, notes, and datasets with a single click. We play nice with everything.",
  },
  {
    number: "02",
    title: "Define Goals",
    description:
      "Tell Sanctuary what you want to achieve. Our AI analyzes your context to provide perfect assistance.",
  },
  {
    number: "03",
    title: "Execute Smoothly",
    description:
      "Draft, automate, and create at the speed of thought. The noise vanishes, the work flows.",
  },
];
    ...
    <section className="section bg-white overflow-hidden">
      <div className="container">
        <div className="text-center mb-20">
          <h2 className="text-3xl md:text-3xl font-bold text-gray-900 mb-4 tracking-tight">
